...
namespace Store.Service.Tests.TestClasses
{
    ...
    public class CustomerControllerTests : BaseTestClass
    {
        ...
        {
            //Get All Customers: http://localhost:61855/api/customer
        ...
        {
            //Get One customer: http://localhost:61855/api/customer/0
            using (var client = new HttpClient())
            {
        ...
        {
            //Get One Category: http://localhost:61855/api/customer/1
            using (var client = new HttpClient())
            {
