...
namespace Store.Service.Tests.TestClasses
{
    ...
    public class CategoryControllerTests : BaseTestClass
    {
        ...
        {
            //Get All Categories: http://localhost:61855/api/category
        ...
        {
            //Get One Category: http://localhost:61855/api/category/1
            using (var client = new HttpClient())
            {
        ...
        {
            //Get One Category: http://localhost:61855/api/category/0
            using (var client = new HttpClient())
            {
        ...
        {
            //Get Products For Category: http://localhost:61855/api/category/{id}/products
            using (var client = new HttpClient())
            {
