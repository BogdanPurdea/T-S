...
namespace Store.Service.Tests.TestClasses
{
    ...
    public class SearchControllerTests : BaseTestClass
    {
        ...
        {
            //Search Products: http://localhost:61855/api/search/{searchString} 
            // Note: encode spaces with % 20
            //http://localhost:61855/api/search/persuade%20anyone
        ...
        {
            //Get Products with Category Name: http://localhost:61855/api/search/persuade%20anyone
            using (var client = new HttpClient())
            {
