...
namespace Store.MVC.WebServiceAccess
{
    public class WebApiCalls : WebApiCallsBase, IWebApiCalls
    {
        ...
        {
            // http://localhost:49222/api/ShoppingCart/0
        ...
        {
            // http://localhost:49222/api/ShoppingCart/0/0
        ...
        {
            //http://localhost:49222/api/shoppingcart/{customerId} HTTPPost
            //Note: ProductId and Quantity in the body
            //http://localhost:49222/api/shoppingcart/0 {"ProductId":22,"Quantity":2}
        ...
        {
            //Purchase: http://localhost:49222/api/shoppingcart/{customerId}/buy HTTPPost
            //Note: Customer in the body
            //{ "Id":1,"FullName":"Super Spy","EmailAddress":"spy@secrets.com"}
            // http://localhost:49222/api/shoppingcart/0/buy
        ...
        {
            // Change Cart Item(Qty): http://localhost:49222/api/shoppingcart/{customerId}/{id}HTTPPut
            ...
            //http://localhost:49222/api/shoppingcart/0/AAAAAAAA86s=
        ...
        {
            //http://localhost:49222/api/category/{id}
        ...
        categoryId)
        {
            // http://localhost:49222/api/category/{categoryId}/products
            var uri = $"{CategoryBaseUri}{categoryId}/products";
            return await GetItemListAsync<ProductAndCategoryBase>(uri);
        }
        public async Task<IList<Customer>> GetCustomersAsync()
        {
            //Get All Customers: http://localhost:49222/api/customer
            return await GetItemListAsync<Customer>($"{CustomerBaseUri}");
        }
        public async Task<Customer> GetCustomerAsync(int id)
        {
            //Get One customer: http://localhost:49222/api/customer/{id}
            //http://localhost:49222/api/customer/1
        ...
        {
            // http://localhost:49222/api/product/featured
        ...
        {
            // http://localhost:49222/api/product/{id}
        ...
        {
            //Get Order History: http://localhost:49222/api/orders/{customerId}
        ...
        {
            //Get Order Details: http://localhost:49222/api/orders/{customerId}/{orderId}
        ...
        {
            //Remove Cart Item:
            // http://localhost:49222/api/shoppingcart/{customerId}/{id}/{TimeStamp} HTTPDelete
            // http://localhost:49222/api/shoppingcart/0/0/AAAAAAAA1Uc=
        ...
        {
            //http://localhost:49222/api/category
